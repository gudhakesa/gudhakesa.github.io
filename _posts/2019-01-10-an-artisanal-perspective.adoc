= Research - An Artisanal Perspective
...
"If you do research, and you feel like it doesn't have any impact to you, there is no purpose of you doing it in the first place. In fact, I bet the research itself, is already useless…"
